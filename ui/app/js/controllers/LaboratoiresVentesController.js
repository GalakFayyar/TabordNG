(function() {
	...
	LaboratoiresVentesController.$inject = ['$scope', '$rootScope', 'HelperService', 'uiGridConstants'];
	function LaboratoiresVentesController ($scope, $rootScope, HelperService, uiGridConstants) {
