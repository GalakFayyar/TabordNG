...
class Merchandising():
    ...
    def create_form(self, data):
        ...
        sql = "INSERT INTO form_merchandising (id_pharmacie, date_operation, libelle, operator, data) VALUES (%s, '%s', '%s', '%s', '%s');" %(pharmacie_id, data['form']['date_operation'], data['form']['operator'], data['form']['libelle'], json.dumps(data['form']['forms']).strip())
